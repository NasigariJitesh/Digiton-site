						...
						<div className='service-details-content wow fadeInRight delay-0-2s'>
							...
							<div className='row pt-25'>
								<div className='col-xl-4 col-lg-6 col-md-4 col-sm-6'>
									<div className='service-normal style-a wow fadeInUp delay-0-2s'>
										<div className='icon'>
								...
								<div className='col-xl-4 col-lg-6 col-md-4 col-sm-6'>
									<div className='service-normal style-a wow fadeInUp delay-0-4s'>
										<div className='icon'>
								...
								<div className='col-xl-4 col-lg-6 col-md-4 col-sm-6'>
									<div className='service-normal style-a wow fadeInUp delay-0-6s'>
										<div className='icon'>
