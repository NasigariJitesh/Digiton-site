...
export default function WorkProgressSection() {
	...
	return (
		<section
			className='work-progress-a bg-black text-white pb-85 rpb-65'
			style={{ backgroundImage: `url(${background})` }}>
			<div className='container'>
				<div className='logo-carousel-wrap style-a bg-white py-100 px-25 br-5'>
				...
				<div className='work-progress-inner-three'>
					<div className='row justify-content-center'>
						<div className='col-lg-4 col-sm-6'>
							<div className='progress-item-a style-a wow fadeInUp delay-0-2s'>
						...
						<div className='col-lg-4 col-sm-6'>
							<div className='progress-item-a style-a wow fadeInUp delay-0-4s'>
						...
						<div className='col-lg-4 col-sm-6'>
							<div className='progress-item-a style-a wow fadeInUp delay-0-6s no-border mb-0'>
