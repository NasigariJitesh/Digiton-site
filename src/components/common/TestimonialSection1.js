					...
					<SliderCom settings={settings}>
						<div className='testimonial-four-item'>
							...
							<div className='testimonial-four-author'>
								<img
									src={require(`../../assets/images/testimonials/testi-four-author-1.png`)}
						...
						<div className='testimonial-four-item'>
							...
							<div className='testimonial-four-author'>
								<img
									src={require(`../../assets/images/testimonials/testi-four-author-2.png`)}
									alt='Testimonial Author'
								/>
								<div className='testimonial-four-author-designation'>
									<h4>Michelle Ley</h4>
						...
						<div className='testimonial-four-item'>
							...
							<div className='testimonial-four-author'>
								<img
									src={require(`../../assets/images/testimonials/testi-four-author-3.png`)}
									alt='Testimonial Author'
								/>
								<div className='testimonial-four-author-designation'>
									<h4>Michael Jack</h4>
